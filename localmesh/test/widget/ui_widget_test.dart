  ...
  group('T5 widget tests', () {
    testWidgets('T5.1 IdentitySetupScreen — name field and generate control', (
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [createIdentityProvider.overrideWithValue(create)],
    ...
    testWidgets('T5.3 MeshTopologyCanvas — renders topology paint', (
      tester,
    ) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(
            home: Scaffold(
              body: MeshTopologyCanvas(
                topology: MeshTopologySnapshot(
                  localId: 'local',
                  localName: 'This node',
                  nodes: {'local': 'This node'},
                  links: [],
                ),
              ),
            ),
    ...
    testWidgets('T5.4 NetworkHealthBody — diagnostics sections', (
      tester,
    ) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            peerEventsProvider.overrideWith(
              (ref) => const Stream<PeerEvent>.empty(),
            ),
          ...
          child: const MaterialApp(home: Scaffold(body: NetworkHealthBody())),
        ),
      );
      ...
      await tester.scrollUntilVisible(find.textContaining('TRANSPORTS'), 400);
      await tester.pumpAndSettle();
    ...
    testWidgets('T5.5 SignalStrengthBars — level renders bars', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: SignalStrengthBars(level: 3))),
      );
